/**
 * ChunkParser - Standalone Version for Seeders
 *
 * Parses TipTap Delta JSON and extracts semantic chunks (H2/H3 sections).
 * Converts formatted content → plain text for embeddings.
 *
 * Duplicated from backend to avoid HTTP API dependency.
 */
