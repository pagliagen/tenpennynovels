...
const ALL_CONFIGS: ConfigRecord[] = [
  ...
  },
  {
    ...
    configSection: 'moderation',
    configType: 'string',
    value: 'MilaNLProc/hate-ita',
    defaultValue: 'MilaNLProc/hate-ita',
    description: 'Nome del modello AI usato per la classificazione di tossicità (ottimizzato per italiano)',
    isActive: true,
    metadata: { version: 1 },
  },
