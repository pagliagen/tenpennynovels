...
import { useOffGameMail, useOffGameMailStats, useHardDeleteOffGameMail, useSoftDeleteOffGameMail } from '@/hooks/api/useMail';
import { useNotificationStore } from '@/store/notificationStore';
import styles from '@/styles/pages/AutoModeration.module.scss';

export default function OffGameMessagesPage() {
  ...
  return (
    <ManagementLayout>
      <Head>
        <title>Ten Penny Novels | Chat OffGame</title>
      </Head>
      ...
      <div className={styles.container}>
        <header className={styles.header}>
          <div>
            <h1>Chat OffGame</h1>
            <p>Tutti i messaggi delle chat dirette e di gruppo</p>
          </div>
        </header>
