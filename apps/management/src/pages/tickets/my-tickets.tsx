      ...
      <div className={styles.userManagement}>
        ...
        <div className={ticketStyles.statsContainer}>
          <div className={ticketStyles.statCard}>
            ...
            <span className={ticketStyles.statLabel}>Totale Assegnati</span>
          </div>
          <div className={ticketStyles.statCard}>
            <span className={ticketStyles.statNumber}>{stats.inProgress}</span>
            <span className={ticketStyles.statLabel}>In Lavorazione</span>
          </div>
          <div className={ticketStyles.statCard}>
          ...
          <div className={ticketStyles.statCard}>
            <span className={ticketStyles.statNumber}>{stats.unread}</span>
            <span className={ticketStyles.statLabel}>Messaggi Non Letti</span>
          </div>
        </div>
