...
export function canModerateContent(user: UserInfo | undefined): boolean {
  return hasPermission(user, 'content.moderate') || hasPermission(user, 'content.manage');
}
...
export function canManageContent(user: UserInfo | undefined): boolean {
  return hasPermission(user, 'content.create') || hasPermission(user, 'content.update') || hasPermission(user, 'content.delete');
}

/**
 * Check if user can delete content
 */
export function canDeleteContent(user: UserInfo | undefined): boolean {
