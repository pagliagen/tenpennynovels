 ...
 * - Add global meta tags (viewport accessibile, favicon)
...
export default function App({ Component, pageProps }: AppProps) {
  ...
  // Report Web Vitals to Google Analytics (only if user consented to cookies / analytics)
  ...
  return (
    <ErrorBoundary>
      ...
      {GA_ID && process.env.NODE_ENV === 'production' && <AnalyticsGate />}
