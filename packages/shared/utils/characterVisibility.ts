...
export class CharacterVisibilityFilter {
  ...
  static filterForPublic(character: Character): FilteredCharacter {
    return {
      ...
      // Campi del background guidato accessibili al pubblico
      guidedBackground: character.guidedBackground ? {
        phobias: character.guidedBackground.phobias,
        pastTraumas: character.guidedBackground.pastTraumas,
        beliefSystem: character.guidedBackground.beliefSystem,
        significantBonds: character.guidedBackground.significantBonds,
        secrets: '' // Non visibile al pubblico - stringa vuota
      } : undefined,
