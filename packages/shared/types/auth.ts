/**
 * Re-export AuthTokenPayload from authentication-backend
 */
export { AuthTokenPayload, CharacterContextPayload } from '../../../services/authentication-backend/src/types/auth';
