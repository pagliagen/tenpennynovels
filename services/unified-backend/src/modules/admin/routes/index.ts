...
import forumTopicManagementRoutes from './forumTopicManagementRoutes';
import forumCategoryManagementRoutes from './forumCategoryManagementRoutes';
import forumDiscussionManagementRoutes from './forumDiscussionManagementRoutes';
import forumPostManagementRoutes from './forumPostManagementRoutes';
...
router.use('/forum-topics', forumTopicManagementRoutes);
router.use('/forum-categories', forumCategoryManagementRoutes);
router.use('/forum-discussions', forumDiscussionManagementRoutes);
router.use('/forum-posts', forumPostManagementRoutes);
