...
import { successResponse, createResponse, getRequestId } from '@shared/utils/apiResponse';

import { ForumBookmark } from '../models/ForumBookmark';
import { ForumPost } from '../models/ForumPost';
import { ForumDiscussion } from '../models/ForumDiscussion';
import { logger } from '../utils/logger';

export class ForumBookmarkController {
  // NOTA (comportamento preesistente preservato): itemType è sempre hardcodato
  // a 'post' qui — i bookmark a livello discussione sono supportati dallo
  // schema ForumBookmark e già gestiti in getBookmarks sotto, ma non sono mai
  // creabili da nessuna parte del codice.
