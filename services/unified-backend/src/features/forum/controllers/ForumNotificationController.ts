...
export class ForumNotificationController {
  // NOTA (comportamento preesistente preservato): risponde con un formato
  // {success, list, pagination} invece di successResponse/listResponse come
  // il resto della superficie forum.
