...
import { recalculateTopicLastPost } from './ForumController';
import { AdminAuthMiddleware } from '@modules/admin/middleware/adminAuth';
import { resolveAdminCharacterSelectionContext } from '@modules/admin/utils/permissions';
 ...
 * features/forum/routes/game.ts, which require req.character. Attribution
