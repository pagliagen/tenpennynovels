...
export class FinancialController {
  ...
  static async getCharacterFinances(req: Request<{ characterId: string }>, res: Response): Promise<void> {
    try {
      ...
      // ATTENZIONE — bug preesistente, preservato esattamente: `maxCreditLine`
      // e `creditResetDate` non esistono sullo schema reale (ICharacterFinances
      // ha creditLine.maxWeekly/.nextResetDate, annidati) — questi due campi
      // sono quindi sempre `undefined` nella risposta.
