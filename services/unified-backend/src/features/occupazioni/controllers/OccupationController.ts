...
//
// ATTENZIONE — bug preesistente, preservato esattamente: `occupation.prerequisites`
// non esiste sullo schema reale di IOccupation (solo name/description/category/
// contacts/earnings/requiredSkillSlots/bonusSkills/image/isActive). Il type-check
// non lo cattura perché `mongoose.models.Occupation || model<IOccupation>(...)`
// collassa il tipo a Model<any>. Effetto pratico: questa funzione ritorna sempre
// `eligible: true`, quindi getAvailableOccupations non filtra mai nulla e
// checkOccupationEligibility approva sempre. Esiste anche una seconda versione,
// non equivalente, in modules/game/utils/characterCreationUtils.ts (anch'essa
// no-op per una ragione diversa) — duplicazione nota, non risolta in questa fase.
