...
export class SocialClassManagementController {
   ...
   */
  static async getSocialClassDetails(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  static async updateSocialClass(req: Request, res: Response): Promise<void> {
    try {
      const { socialClassId } = req.params;
      const { user } = req as any;
   ...
   */
  static async deleteSocialClass(req: Request, res: Response): Promise<void> {
    try {
      const { socialClassId } = req.params;
      const { user } = req as any;
