...
export class TicketManagementController {
   ...
   */
  static async getSpecificDepartmentTickets(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  static async updateTicketPriority(req: Request, res: Response): Promise<void> {
    try {
      const ticketId = req.params.id;
   ...
   */
  static async updateInternalNote(req: Request, res: Response): Promise<void> {
    try {
      const ticketId = req.params.id;
