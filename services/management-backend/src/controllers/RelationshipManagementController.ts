...
export class RelationshipManagementController {
   ...
   */
  static async updateRelationshipType(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  static async deleteRelationshipType(req: Request, res: Response): Promise<void> {
    try {
      const { relationshipTypeId } = req.params;
      const { user } = req as any;
   ...
   */
  static async moderateRelationship(req: Request, res: Response): Promise<void> {
    try {
