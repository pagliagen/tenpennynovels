...
// Economy Administration Types
export interface MoneyGrant {
  characterId: string;
  amount: number;
  type: 'cash' | 'deposit';
  reason: string;
  category: 'reward' | 'compensation' | 'correction' | 'event_prize';
...
export interface EconomicReports {
  moneySupply: MoneySupplyReport;
  transactionActivity: TransactionActivityReport;
  itemEconomy: ItemEconomyReport;
  corporationFinances: CorporationFinancesReport;
...
export interface CorporationFinancesReport {
