...
export interface IUserReport extends Document {
  ...
  reporterId: Schema.Types.ObjectId; // Character ID
  reporterName: string;
  reporterUserId: Schema.Types.ObjectId; // User ID
  
  // Reported user information
  reportedCharacterId: Schema.Types.ObjectId;
  ...
  assignedTo?: Schema.Types.ObjectId; // Admin/Moderator ID
  assignedUsername?: string;
  
  // Processing information
  actionTaken?: Schema.Types.ObjectId; // Reference to ChatModerationAction
...
// Export models
export const ChatModerationAction = mongoose.model<IChatModerationAction>('ChatModerationAction', ChatModerationActionSchema);
