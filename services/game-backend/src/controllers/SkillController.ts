...
export class SkillController {
   ...
   */
  static async getCharacterSkillsForDice(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async getSkillDetails(req: Request, res: Response): Promise<void> {
    try {
      if (!req.character) {
        res.status(401).json(errorResponse(
          'Character context required',
  ...
  static async calculateSkillProbabilities(req: Request, res: Response): Promise<void> {
    try {
      if (!req.character) {
        res.status(401).json(errorResponse(
          'Character context required',
